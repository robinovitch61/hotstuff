import {MouseEvent as SyntheticMouseEvent, RefObject, useCallback, useRef, useState} from "react";
import {HotNode, Point} from "../../App";
import Qty from "js-quantities";

export default function useNodes(startNodes: HotNode[]): [HotNode[], (e: SyntheticMouseEvent) => void] {
  const [nodes, setNodes] = useState<HotNode[]>(startNodes);

  const addNode = (e: SyntheticMouseEvent) => setNodes([...nodes, {
